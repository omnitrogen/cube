...
COLOR_MIN = np.array([17, 99, 140],np.uint8)       # HSV color code lower and upper bounds
COLOR_MAX = np.array([68, 255, 255],np.uint8)       # color yellow 
